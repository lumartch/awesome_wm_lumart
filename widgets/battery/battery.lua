...
local function worker(args)
    ...
    local path_to_icons = args.path_to_icons or HOME .. "/.config/awesome/widgets/symbolic/"
    ...
    local warning_msg_icon = args.warning_msg_icon or HOME .. '/.config/awesome/widgets/battery/spaceman.jpg'
